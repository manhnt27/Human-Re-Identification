...
def visualize_ranked_results(
    ...
    for q_idx in range(num_q):
        ...
        if data_type == 'image':
            ...
            qimg = cv2.resize(qimg, (width, height))
            cv2.putText(qimg,str(qpid) + " " + str(qcamid), (1, 240), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,0,0), 2)
        ...
        for g_idx in indices[q_idx, :]:
            ...
            if not invalid:
                ...
                if data_type == 'image':
                    ...
                    gimg = cv2.resize(gimg, (width, height))
                    cv2.putText(gimg,str(gpid), (1, 240), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,0,0), 2)
