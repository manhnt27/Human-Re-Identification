...
class DataManager(object):
    ...
    @property
    def num_ids_from_id(self):
        """Returns the number of ids from a particular id."""
        return self._num_ids_from_id
...
class ImageDataManager(DataManager):
    ...
    def __init__(
        ...
        for name in self.targets:
            ...
            galleryset_t.append(galleryset)
        ...
        galleryset_t = sum(galleryset_t)
        self._num_ids_from_id = galleryset_t.num_ids_from_id
