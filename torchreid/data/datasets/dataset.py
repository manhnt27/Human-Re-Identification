...
class Dataset(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Add by manh
        self.num_ids_from_id = self.get_num_ids_from_id(self.gallery)
    ...
    # Add by manh
    def get_num_ids_from_id(self, data):
        """Returns the number of personal identities from a particular identity
...
class ImageDataset(Dataset):
    ...
    def show_summary(self):
        ...
        num_gallery_cams = self.get_num_cams(self.gallery)
        # Add by manh
        num_ids_from_id = self.get_num_ids_from_id(self.gallery)
        ...
        # Add by manh 
        for id in num_ids_from_id:
            print(id, " ", num_ids_from_id.get(id))
        print('  ----------------------------------------')
